...
import './homePage.css'; // Ensure you create this CSS file or add styles to your main CSS
  ...
  return (
    <div className="w-full h-[600px] grid grid-cols-2 justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-blue-800">
      ...
      <div className='flex mt-[180px] ml-[66px]'>
        <div className="mb-14">
          <div className="sm:text-1xl font-bold border-2 px-2 py-1 whitespace-nowrap text-white bg-gradient-to-b from-pink-200 to-purple-900">
            Welcome to my portfolio
          </div>
        </div>
        <div className="-ml-[210px] mt-20 pr-[10px] md:pr-[120px]">
          <h1 className="text-2xl text-white h-14 md:ml-[0px] lg:-ml-[10px]">
            {displayedText}
          </h1>
